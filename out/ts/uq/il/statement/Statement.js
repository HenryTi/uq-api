...
class BinStateActStatements extends Statements {
    constructor(parent, bizAct) {
        super(parent);
        this.createStatements = (parent) => {
...
exports.BinStateActStatements = BinStateActStatements;
