...
class BizBudJSON extends BizBudValue {
    constructor() {
        super(...arguments);
        this.dataType = BizPhraseType_1.BudDataType.json;
        this.canIndex = false;
    }
    parser(context) {
        return new parser_1.PBizBudJSON(this, context);
    }
