...
class BBizSheet extends BizEntity_1.BBizEntity {
    ...
    buildDetail(statements, detail, loopNo) {
        ...
        declare.vars((0, il_1.bigIntField)(sheetId), (0, il_1.bigIntField)(si), (0, il_1.bigIntField)(sx), (0, il_1.decField)(svalue, 18, 6), (0, il_1.decField)(samount, 18, 6), (0, il_1.decField)(sprice, 18, 6), (0, il_1.bigIntField)(pendFrom), (0, il_1.bigIntField)(detailId), (0, il_1.bigIntField)(i), (0, il_1.bigIntField)(x), (0, il_1.decField)(value, 18, 6), (0, il_1.decField)(amount, 18, 6), (0, il_1.decField)(price, 18, 6), (0, il_1.bigIntField)(pDetailId));
        ...
        select.from(new statementWithFrom_1.EntityTable(dbContext_1.EnumSysTable.bizBin, false, a))
            ...
            .join(il_1.JoinType.join, new statementWithFrom_1.EntityTable(dbContext_1.EnumSysTable.bizBin, false, c))
