...
class BBizSheet extends BizEntity_1.BBizEntity {
    ...
    buildDetail(statements, detail, loopNo) {
        ...
        declare.vars((0, il_1.bigIntField)(detailId), (0, il_1.bigIntField)(item), (0, il_1.bigIntField)(itemX), (0, il_1.decField)(value, 18, 6), (0, il_1.decField)(amount, 18, 6), (0, il_1.decField)(price, 18, 6), (0, il_1.bigIntField)(pDetailId));
        ...
        select.from(new statementWithFrom_1.EntityTable('detail', false, a))
            .join(il_1.JoinType.join, new statementWithFrom_1.EntityTable('bud', false, b))
            .on(new sql_1.ExpEQ(new sql_1.ExpField('id', b), new sql_1.ExpField('base', a)));
        select.where(new sql_1.ExpAnd(new sql_1.ExpGT(new sql_1.ExpField('id', a), new sql_1.ExpVar(pDetailId)), new sql_1.ExpEQ(new sql_1.ExpField('base', b), new sql_1.ExpVar('$id'))));
        ...
        setDetailNull.equ(detailId, new sql_1.ExpNull());
    }
}
