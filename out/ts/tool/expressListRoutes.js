...
exports.expressListRoutes = void 0;
            ...
            if (stack.route) {
                ...
                for (const route of stack.route.stack) {
                    ...
                    if (!routeLogged[method] && method) {
                        ...
                        const stackSpace = spaces(options.spacer - method.length);
                        const stackPath = path.resolve([options.prefix, stack.routerPath, stack.route.path, route.path].filter((s) => !!s).join(''));
...
exports.expressListRoutes = expressListRoutes;
;
//# sourceMappingURL=expressListRoutes.js.map