...
class Db {
    ...
    */
    ...
    logPerformance(tick, log, ms) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.dbCaller.call('$uq', 'performance', [tick, log, ms]);
            }
            catch (err) {
                ...
                if (sqlMessage)
                    msg += ' ' + sqlMessage;
                yield this.dbCaller.call('$uq', 'performance', [Date.now(), msg, 0]);
            }
        });
    }
    createProcObjs() {
    ...
    sqlDropProc(procName, isFunc) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dbCaller.sqlDropProc(this.dbName, procName, isFunc);
        });
    }
    sqlProc(procName, procSql) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dbCaller.sqlProc(this.dbName, procName, procSql);
        });
    }
    buildProc(procName, procSql, isFunc) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.dbCaller.buildProc(this.dbName, procName, procSql, isFunc);
        });
    }
    buildRealProcFrom$ProcTable(proc) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.dbCaller.buildRealProcFrom$ProcTable(this.dbName, proc);
        });
    }
    call(proc, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dbCaller.call(this.dbName, proc, params);
        });
    }
    callEx(proc, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dbCaller.callEx(this.dbName, proc, params);
        });
    }
    tableFromProc(proc, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dbCaller.tableFromProc(this.dbName, proc, params);
        });
    }
    tablesFromProc(proc, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dbCaller.tablesFromProc(this.dbName, proc, params);
        });
    }
    createDatabase() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dbCaller.createDatabase(this.dbName);
        });
    }
    buildDatabase() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dbCaller.buildDatabase(this.dbName);
        });
    }
    setDebugJobs() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    createResDb(resDbName) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.dbCaller.createResDb(resDbName);
        });
    }
    create$UqDb() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.dbCaller.create$UqDb();
        });
    }
    isExistsProcInDb(proc) {
        return this.dbCaller.isExistsProcInDb(proc);
    }
    createProcInDb(proc) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.dbCaller.createProcInDb(this.dbName, proc);
        });
    }
}
exports.Db = Db;
