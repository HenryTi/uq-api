import { ParamQueryID, EntitySchema } from "../../IDDefines";
...
export class SqlQueryID extends MySqlBuilder<ParamQueryID> {
    private cols: string = '';
    ...
    protected override convertParam(p: ParamQueryID): ParamQueryID {
        let { ID, IDX, IX } = p;
