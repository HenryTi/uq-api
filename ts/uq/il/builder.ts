...
import { Biz, BizAct, BizBinAct, BizStatement, FromStatement, FromStatementInPend, FromStatementInQuery } from './Biz';
...
export interface Builder {
    ...
    fromStatementInQuery(v: FromStatementInQuery): BStatement;
