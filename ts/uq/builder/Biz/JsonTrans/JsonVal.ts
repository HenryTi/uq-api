import { BizBud, BizBudArr, BudDataType, EnumSysTable, Field, IOPeer, IOPeerArr, IOPeerID, IOPeerOptions, IOPeers, JoinType, JsonTableColumn, PeerIDKey, PeerType, bigIntField, charField, decField, jsonField } from "../../../il";
import { DbContext } from "../../dbContext";
import { ExpAnd, ExpComplex, ExpEQ, ExpField, ExpFunc, ExpFuncDb, ExpFuncInUq, ExpNull, ExpNum, ExpSelect, ExpStr, ExpVal, ExpVar } from "../../sql";
...
export abstract class JsonVal {
    ...
    protected transOptions(peer: IOPeerOptions, val: ExpVal): ExpVal {
        ...
        select.where(new ExpAnd(
            ...
            new ExpEQ(new ExpField('name', a), new ExpFunc(factory.func_concat, new ExpField('name', b), new ExpStr('.'), val)),
        ));
        return new ExpSelect(select);
    }
}
