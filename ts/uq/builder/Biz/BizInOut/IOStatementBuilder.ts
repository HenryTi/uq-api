import { EnumSysTable, Index, JoinType, JsonTableColumn, bigIntField, charField, intField } from "../../../il";
...
export class IOStatementBuilder {
    ...
    transErrorTable() {
        ...
        const appIDField = bigIntField('appID');
        ...
        let indexAppIDAtom = new Index('appID_atom', true);
        indexAppIDAtom.fields.push(appIDField, atomField);
        let indexAppIDNo = new Index('appID_no', true);
