import { BigInt, BizDetailActStatement, BizDetailActSubPend, BizDetailActSubTab, SetEqu } from "../../il";
import { EnumSysTable } from "../dbContext";
import { ExpAdd, ExpAnd, ExpEQ, ExpField, ExpFuncInUq, ExpNum, ExpSub, ExpVal, ExpVar } from "../sql";
...
export class BBizDetailActSubBud extends BStatement<BizDetailActSubTab> {
    head(sqls: Sqls): void {
