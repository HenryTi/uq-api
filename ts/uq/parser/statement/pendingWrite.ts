...
import {ValueExpression, CompareExpression, Statements, Book, Pending, PendingWrite, VarPointer, GroupType, Entity, Table, Pointer} from '../../il';
...
export class PPendingWrite extends PStatement {
    ...
    scan(space: Space): boolean {
        ...
        if (idVar !== undefined) {
            let idPointer = this.write.idPointer = space.varPointer(idVar, undefined) as VarPointer;
